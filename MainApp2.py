...
driver.get('http://www.statiz.co.kr/stat.php?opt=0&sopt=0&re=0&ys=2019&ye=2019&se=0&te=&tm=&ty=0&qu=auto&po=0&as=&ae=&hi=&un=&pl=&da=1&o1=WAR_ALL_ADJ&o2=TPA&de=1&lr=0&tr=&cv=&ml=1&sn=30&si=&cn=')
...
for i in num:
    if i == 13 or i == 14:
        ...
        ranking = driver.find_element_by_xpath('//*[@id="mytable"]/tbody/tr[{}]/td[1]'.format(i)).text  # 순위
    ...
    i += 1
    # //*[@id="mytable"]/tbody/tr[13] //*[@id="mytable"]/tbody/tr[14] # 필요 없는 파일
